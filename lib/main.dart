import 'package:fl_studyapp/Pages/color_picker.dart';
          ...
          (context, darkLightModeChanger, _) => MaterialApp(
            ...
            theme: ThemeData(
              colorScheme: ColorScheme.fromSeed(
                seedColor: darkLightModeChanger.color,
              ), //Colors.deepPurple),
            ),
            darkTheme: ThemeData(
              colorScheme: ColorScheme.fromSeed(
                seedColor: darkLightModeChanger.color, // Colors.deepPurple,
          ...
          (context, darkLightModeChanger, _) => Scaffold(
            appBar: AppBar(
              ...
              actions: [
                ...
                IconButton(
                  onPressed: () {
                    ColorPickerDialog.show(darkLightModeChanger);
                  },
            ...
            floatingActionButton: FloatingActionButton(
              focusColor: darkLightModeChanger.color,
              backgroundColor: darkLightModeChanger.color,
              onPressed: () {
